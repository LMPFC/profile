...
directoryNameToPrintTo = sprintf(...
    'flowProfileMeshes/flowProfile_0p%04dSpacing_%04drRes%04dthetaRes%04dzRes0p%04drPipe0p%04dlPipe_0p%03dOR0p%03dIR0p%03dh',...
    round(rFlowCenter*1e4),radialRes,thetaRes,lengthRes,rPipe*1e4,lPipe*1e4,rout*1e3,rin*1e3,h*1e3);
